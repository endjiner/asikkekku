 ...
 */
class Migration_Hardening_soft_delete_indexes extends CI_Migration
{
	public function up()
	{
		if (!$this->db->field_exists('KegiatanDeletedAt', 'tb_kegiatan')) {
			$this->dbforge->add_column('tb_kegiatan', array(
	...
	public function down()
	{
		...
		if ($this->db->field_exists('KegiatanDeletedAt', 'tb_kegiatan')) {
			$this->dbforge->drop_column('tb_kegiatan', 'KegiatanDeletedAt');
		}
	}
}
