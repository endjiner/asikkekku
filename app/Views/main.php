...
<?= view('layouts/header', get_defined_vars()) ?>

<?php if (isset($header)): ?>
  <?= view($header, get_defined_vars()) ?>
<?php endif ?>
...
<body class="hold-transition app-topnav page-<?= isset($menu_detail['MenuKode']) ? preg_replace('/[^0-9a-zA-Z]/', '', $menu_detail['MenuKode']) : 'x' ?>">
  ...
  <main class="app-main">
    ...
    if (realpath($link)) {
        echo view($body, get_defined_vars());
    } else {
        echo view('dashboard/UnderConstruction', get_defined_vars());
    }
    ?>
...
<?= view('layouts/footer', get_defined_vars()) ?>

<?php if (isset($footer)): ?>
  <?= view($footer, get_defined_vars()) ?>
<?php endif ?>
<?php if (isset($footer_addt)): ?>
  <?= view($footer_addt, get_defined_vars()) ?>
<?php endif ?>
