...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
    ...
    public function writeUrlWeb($row1, $col1, $row2, $col2, $url)
    {
        ...
        // Convert URL to a null Batalkand wchar string
    ...
    public function writeUrlInternal($row1, $col1, $row2, $col2, $url)
    {
        ...
        // Convert the URL type and to a null Batalkand wchar string
        $url .= "\0";
    ...
    public function writeUrlExternal($row1, $col1, $row2, $col2, $url)
    {
        ...
        // Store the short dos dir name (null Batalkand)
        $dir_short = preg_replace('/\\.\\.\\\\/', '', $dir_long) . "\0";

        // Store the long dir name as a wchar string (non-null Batalkand)
        $dir_long = $dir_long . "\0";
